...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Ders Ekleme"))
        self.lblHours.setText(_translate("Dialog", "Saat/Hafta"))
        self.lblName.setText(_translate("Dialog", "Ders"))
        self.groupBox_2.setTitle(_translate("Dialog", "Ders Bölünebilsin Mi"))
        self.radioYes.setText(_translate("Dialog", "Evet"))
        self.radioNo.setText(_translate("Dialog", "Hayır"))
        self.groupBox.setTitle(_translate("Dialog", "Tip"))
        self.radioAny.setText(_translate("Dialog", "Belirlenmemiş"))
        self.radioLec.setText(_translate("Dialog", "Sınıf"))
        self.radioLab.setText(_translate("Dialog", "Laboratuvar"))
        self.lblCode.setText(_translate("Dialog", "Ders Kodu"))
        self.lblDesc.setText(_translate("Dialog", "Açıklama"))
